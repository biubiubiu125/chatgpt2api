...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    image_account_fallback_limit: Number(config.image_account_fallback_limit ?? 10),
  ...
  saveConfig: async () => {
    ...
    try {
      ...
      const data = await updateSettingsConfig({
        ...
        image_account_fallback_limit: Math.min(10, Math.max(0, Number(config.image_account_fallback_limit) || 0)),
        image_settle_enabled: Boolean(config.image_settle_enabled !== false),
        image_check_before_hit_enabled: Boolean(config.image_check_before_hit_enabled !== false),
      ...
      registerConfig: {
        ...
        mail: {
          ...
          providers: [
            ...
            { provider_id: createProviderId(), enable: true, type: "cloudmail_gen", api_base: "", admin_email: "", admin_password: "", domain: [], subdomain: [], email_prefix: "" },
          ],
        },
      },
    } : {});
